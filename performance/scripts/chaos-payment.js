...
const metrics = createMetrics('ticketcraft_chaos_payment');
...
export const options = {
    ...
    thresholds: {
        ...
        ticketcraft_chaos_payment_create_order_failed: ['rate<0.01'],
    },
};
...
export default function () {
    ...
    const response = createOrder('70000000', ticketNumber, 'chaos_payment');
